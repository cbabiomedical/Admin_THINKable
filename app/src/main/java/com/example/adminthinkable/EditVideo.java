...
public class EditVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meditationName = findViewById(R.id.videoTitle);
        meditationId = findViewById(R.id.videoId);
...
//                }
                ...
                if (selectedAudioUri == null) {
                    songUrlUpdated = uri;
                    Log.d("Uri Null",String.valueOf(uri));
                }
                ID.put("videoUrl", songUrlUpdated);
                Log.d("UpdateSongUrlFinal", songImageUpdated);
                if (imageUrl == null) {
                    songImageUpdated = image;
                }
                ID.put("videoImage", songImageUpdated);
                Log.d("UpdateImageFinal", songImageUpdated);
                ID.put("videoId", songIdUpdated);
                ID.put("videoName", songNameUpdated);
                                ...
                                for (int i=0;i<1;i++) {
                                    reference1.updateChildren(ID).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            Toast.makeText(EditVideo.this, "Successful", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        ...
                        if (imageUri != null) {
                            ...
                            fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(EditVideo.this, "Failed Uploading Image...", Toast.LENGTH_SHORT).show();
                                }
                            });
                        } else {
                            Toast.makeText(EditVideo.this, "No file Selected to uploads", Toast.LENGTH_SHORT).show();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if (audioUri != null) {
                            Toast.makeText(EditVideo.this, "Upload please wait !", Toast.LENGTH_SHORT);
