...
//
        ...
        editSong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), DisplayUploadedVideo.class));
            }
        });
    ...
    private void uploadFiles() {
        ...
        fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(VideoActivity.this, "Failed Uploading Image...", Toast.LENGTH_SHORT).show();
            }
        });
